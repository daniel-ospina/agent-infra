...
**Loop count:** 2 minimum. If loop 2 still has critical findings → run loop 3. Then continue to convergence — the bound is `proportional-gates`' proportional table (3 / 5 / 10 by risk tier), never a flat 4.
