---
name: task-workflow-micro
description: Lightweight fractal pipeline for micro tasks. Routes through all 6 stages inline — no Bounded skill dispatch. Agent applies the phase discipline directly.
type: Workflow
domain: capability
status: live
tags: [pipeline, task, planning, fractal, orchestrator, lightweight, micro]
