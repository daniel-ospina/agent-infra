...
> **Sync note:** Canonical copy at `agent-infra/skills/ux-qa/SKILL.md`. Product repos hard-link into `operations/skills/ux-qa/SKILL.md`; Pi reads via `~/.pi/agent/skills`. Edit the agent-infra copy only.
