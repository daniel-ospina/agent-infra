...
print("  2. Move the WHOLE geometry in the SAME commit (#1316): the guard's CLAMP,")
print("     settings.json's reserveTokens (from the reviewed 16384), and the floor")
print("     literal in BOTH instruments — fleet-cost-report.sh's FLEET_REGIME_TB:-<n>")
print("     default and this file's clamp-bucket boundary. Flipping CLAMP alone now")
print("     trips a settings-class block (CLAMP − reserve ≠ the instrument floor),")
print("     which COST_CLAMP_OVERRIDE=1 does NOT silence.")
