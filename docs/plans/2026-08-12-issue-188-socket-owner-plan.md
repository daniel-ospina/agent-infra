...
|---|---|---|
| Election + saturation | `extensions/slack-bridge/socket-mode.ts` | ~200 lines: lease claim/takeover/heartbeat/release, saturation backoff, guards in onerror/onclose/disconnect/openSocket |
